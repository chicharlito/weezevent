     ...
     <div class="form-container">
        <form method="post">
            ...
            <div class="form-group">
             <input type="text" class="form-control" name="txt_uname_email" placeholder="Pseudo ou adresse mail" required />
            </div>
            <div class="form-group">
            ...
            <br />
            <label>Vous n'avez pas encore de compte ? <a href="sign-up.php">Créez un compte</a></label>
        </form>
       </div>
</div>
